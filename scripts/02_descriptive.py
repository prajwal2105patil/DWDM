...
# Handle boolean outputs correctly
if 'Outcome_True' in df_encoded.columns:
    target_col = 'Outcome_True'
...
# Save the plot
plt.savefig(OUTPUTS_DIR / 'pca_plot.png')
print(f"Visualization saved to '{OUTPUTS_DIR / 'pca_plot.png'}'")
